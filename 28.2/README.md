...
- `28.2-ubuntu` ([28.2/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.2/ubuntu/Dockerfile))
- `28.2-debian` ([28.2/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.2/debian/Dockerfile))
- `28.2-alpine` ([28.2/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.2/alpine/Dockerfile))
