...
- `30.3-ubuntu` ([30.3/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/30.3/ubuntu/Dockerfile))
- `30.3-centos` ([30.3/centos/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/30.3/centos/Dockerfile))
- `30.3-alpine` , `latest` ([30.3/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/30.3/alpine/Dockerfile))
