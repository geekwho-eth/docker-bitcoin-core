...
- `27.2-ubuntu` ([27.2/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/27.2/ubuntu/Dockerfile))
- `27.2-debian` ([27.2/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/27.2/debian/Dockerfile))
- `27.2-alpine` ([27.2/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/27.2/alpine/Dockerfile))
