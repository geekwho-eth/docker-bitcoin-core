...
- `27.1-ubuntu` ([27.1/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/27.1/ubuntu/Dockerfile))
- `27.1-debian` ([27.1/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/27.1/debian/Dockerfile))
- `27.1-alpine` ([27.1/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/27.1/alpine/Dockerfile))
