...
- `29.1-ubuntu` ([29.1/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.1/ubuntu/Dockerfile))
- `29.1-debian` ([29.1/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.1/debian/Dockerfile))
- `29.1-alpine` ([29.1/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.1/alpine/Dockerfile))
