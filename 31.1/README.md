...
- `31.1-ubuntu` ([31.1/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/31.1/ubuntu/Dockerfile))
- `31.1-centos` ([31.1/centos/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/31.1/centos/Dockerfile))
- `31.1-alpine` , `latest` ([31.1/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/31.1/alpine/Dockerfile))
