...
- `25.2-ubuntu` ([25.2/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/25.2/ubuntu/Dockerfile))
- `25.2-debian` ([25.2/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/25.2/debian/Dockerfile))
- `25.2-alpine` ([25.2/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/25.2/alpine/Dockerfile))
