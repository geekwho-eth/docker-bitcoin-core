...
- `28.1-ubuntu` ([28.1/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.1/ubuntu/Dockerfile))
- `28.1-debian` ([28.1/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.1/debian/Dockerfile))
- `28.1-alpine` ([28.1/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.1/alpine/Dockerfile))
