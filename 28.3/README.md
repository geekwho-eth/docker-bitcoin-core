...
- `28.3-ubuntu` ([28.3/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.3/ubuntu/Dockerfile))
- `28.3-debian` ([28.3/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.3/debian/Dockerfile))
- `28.3-alpine` ([28.3/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.3/alpine/Dockerfile))
