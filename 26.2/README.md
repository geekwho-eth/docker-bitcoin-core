...
- `26.2-ubuntu` ([26.2/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/26.2/ubuntu/Dockerfile))
- `26.2-debian` ([26.2/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/26.2/debian/Dockerfile))
- `26.2-alpine` ([26.2/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/26.2/alpine/Dockerfile))
