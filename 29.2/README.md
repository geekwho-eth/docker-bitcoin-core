...
- `29.2-ubuntu` ([29.2/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.2/ubuntu/Dockerfile))
- `29.2-debian` ([29/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.2/debian/Dockerfile))
- `29.2-alpine` ([29/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.2/alpine/Dockerfile))
