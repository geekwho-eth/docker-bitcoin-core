...
- `30.1-ubuntu` ([30.1/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/30.1/ubuntu/Dockerfile))
- `30.1-centos` ([30.1/centos/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/30.1/centos/Dockerfile))
- `30.1-alpine` , `latest` ([30.1/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/30.1/alpine/Dockerfile))
