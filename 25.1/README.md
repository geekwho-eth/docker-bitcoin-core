...
- `25.1-ubuntu` ([25.1/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/25.1/ubuntu/Dockerfile))
- `25.1-debian` ([25.1/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/25.1/debian/Dockerfile))
- `25.1-alpine` ([25.1/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/25.1/alpine/Dockerfile))
