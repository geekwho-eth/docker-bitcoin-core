...
- `29.4-ubuntu` ([29.4/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.4/ubuntu/Dockerfile))
- `29.4-debian` ([29.4/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.4/debian/Dockerfile))
- `29.4-alpine` ([29.4/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/29.4/alpine/Dockerfile))
