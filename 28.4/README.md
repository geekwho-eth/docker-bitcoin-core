...
- `28.4-ubuntu` ([28.4/ubuntu/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.4/ubuntu/Dockerfile))
- `28.4-debian` ([28.4/debian/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.4/debian/Dockerfile))
- `28.4-alpine` ([28.4/alpine/Dockerfile](https://github.com/geekwho-eth/docker-bitcoin-core/blob/master/28.4/alpine/Dockerfile))
